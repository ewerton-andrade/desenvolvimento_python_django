...
SECRET_KEY = 'django-insecure-ze9qn1gi-go&y08gj=4b#c!1zk@vk03$6@8ply-ag3)%btta=$'
...
INSTALLED_APPS = [
    'parking_app', #Registro da aplicação no projeto como um todo.
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'parking_project/static')
]
